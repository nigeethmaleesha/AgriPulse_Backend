...
// Same test data used for the Heap scheduler
const batches = [
    {
        batchId: "B001",
        priorityScore: 90,
...
const result = knapsackScheduler(
    batches,
    availableHours
);
...
console.log("0/1 Knapsack Scheduler");
console.log("====================================");
...
console.log("Total Priority:", result.totalPriority);