...
- database: `agripulse_module4_spoilage`
- port: `8081`
...
```sql
CREATE DATABASE agripulse_module4_spoilage;
```
...
```text
DB_HOST=localhost;DB_PORT=5432;DB_NAME=agripulse_module4_spoilage;DB_USER=postgres;DB_PASSWORD=1234;SERVER_PORT=8081
```
