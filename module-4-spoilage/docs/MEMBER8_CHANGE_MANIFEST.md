...
- `application.properties`: database password is no longer hard-coded; environment variables are used. The default dev database is `agripulse_module4_spoilage` and default port is `8081` to avoid conflict with Module 3.
