# Historical Base Notes

> This file came from the Module 3 base used by the Module 5 developer. For the actual Module 5 runtime, use `README_INTEGRATED.md` and the project-root `RUN_GUIDE_SINGLISH.md`.
